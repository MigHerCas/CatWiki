  ...
  return (
    <section className="breed-photos">
      ...
      <div className="breed-photos__grid">
        <LazyImage className="w-2 h-3" src={CatPic1} alt="Cat" />
        <LazyImage className="w-2 h-2" src={CatPic2} alt="Cat" />
        <LazyImage className="w-2 h-3" src={CatPic3} alt="Cat" />
        <LazyImage className="w-2 h-5" src={CatPic4} alt="Cat" />
        <LazyImage className="w-2 h-2" src={CatPic5} alt="Cat" />
        <LazyImage className="w-2 h-2" src={CatPic6} alt="Cat" />
        <LazyImage className="w-2 h-2" src={CatPic7} alt="Cat" />
        <LazyImage className="w-2 h-2" src={CatPic8} alt="Cat" />
      </div>
    </section>
  );
}
